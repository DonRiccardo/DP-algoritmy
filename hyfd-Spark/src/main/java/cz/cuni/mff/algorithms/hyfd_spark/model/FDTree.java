...
*/	
	...
	public int addFunctionalDependenciesInto(_CSVTestCase resultReceiver, ObjectArrayList<_ColumnIdentifier> columnIdentifiers, List<PositionListIndex> plis) /*throws CouldNotReceiveResultException, ColumnNameMismatchException*/ {
