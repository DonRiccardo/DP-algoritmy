...
package cz.cuni.mff.algorithms.hyfd_spark.services;
...
public class PLIBuilder {
	...
	public List<PositionListIndex> getPLIs(_CSVTestCase relationalInput, int numAttributes, boolean isNullEqualNull) /*throws InputIterationException*/ {
    ...
    protected List<HashMap<String, IntArrayList>> calculateClusterMaps(_CSVTestCase relationalInput, int numAttributes) /*throws InputIterationException */{
