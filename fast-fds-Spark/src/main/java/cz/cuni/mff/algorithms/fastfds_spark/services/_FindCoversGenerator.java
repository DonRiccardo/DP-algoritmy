...
//import de.metanome.algorithms.fastfds_spark.fastfds_helper_spark.modules.Algorithm_Group2_Modul;
//import de.metanome.algorithms.fastfds_spark.fastfds_helper_spark.modules.container.FunctionalDependencyGroup2;
import cz.cuni.mff.algorithms.fastfds_spark.model._FunctionalDependencyGroup;
import cz.cuni.mff.algorithms.fastfds_spark.model._DifferenceSet;
import cz.cuni.mff.algorithms.fastfds_spark.model._FunctionalDependency;
...
public class _FindCoversGenerator /*extends Algorithm_Group2_Modul */ implements Serializable{

    //private FunctionalDependencyResultReceiver receiver;
    private List<String> columnNames;
    private String tableIdentifier;
    private int numberOfAttributes;
    private static HashSet<Tuple2<BitSet, Integer>> outputFds;

    public _FindCoversGenerator(/*FunctionalDependencyResultReceiver resultReceiver, */List<String> columnNames,
                               String tableIdentifier,/* int numberOfThreads,*/ int numberOfAttributes, HashSet<Tuple2<BitSet, Integer>> outputFds) {
    ...
    public List<_FunctionalDependencyGroup> execute(JavaRDD<_DifferenceSet> differenceSets)
        ...
        */
        ...
        List<_FunctionalDependencyGroup> result = new LinkedList<_FunctionalDependencyGroup>();
    ...
    private void addFdToReceivers(_FunctionalDependencyGroup fdg) /*throws CouldNotReceiveResultException, ColumnNameMismatchException */{
        ...
        _FunctionalDependency fd = fdg.buildDependency(this.tableIdentifier, this.columnNames);
        //this.receiver.receiveResult(fd);
        //System.out.println(fdg.toString());
        BitSet b = new BitSet();
        for (int i : fdg.getValues()) b.set(i);
        
        this.outputFds.add(new Tuple2<>(b, fdg.getAttributeID()));
